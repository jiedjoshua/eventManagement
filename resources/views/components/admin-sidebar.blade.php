...
<aside class="w-64 bg-gradient-to-b from-gray-50 to-white shadow-xl border-r border-gray-200 flex flex-col h-screen">
    ...
    <nav class="flex-1 px-4 space-y-1 text-sm text-gray-700 py-6 overflow-y-auto">
        ...
        <div class="mb-6">
            ...
            <a href="{{ route('admin.packages.index') }}?type=Debut" 
               class="flex items-center space-x-3 pl-4 py-3 rounded-xl transition-all duration-300 {{ $activePage === 'debut-packages' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600 text-white shadow-lg' : 'hover:bg-yellow-50 hover:text-yellow-700' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
